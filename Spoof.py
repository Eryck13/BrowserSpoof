...
def spoof(site,count):
            ...
            if '@' in PROXY:
                ...
                a=driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]/div[1]/input")
                a.send_keys(user)
                b=driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]/div[2]/input")
                b.send_keys(password)
                c=driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]/div[3]/input")
                c.clear()
                d=driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]/div[3]/input")
                d.send_keys("2")
                e=driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]/button[1]")
                e.click()
                driver.get(str(site))
            else: 
                chrome_options = Options()
