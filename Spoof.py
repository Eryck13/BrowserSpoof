...
def spoof(site,count):
            ...
            if '@' in PROXY:
                ...
                driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]/div[1]/input").send_keys(user)
                driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]/div[2]/input").send_keys(password)
                driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]/div[3]/input").clear()
                driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]/div[3]/input").send_keys("2")
                driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]/button[1]").click()
                driver.get(str(site))
            else: 
                chrome_options = Options()
                chrome_options.add_argument("--proxy-server=http://{}".format(PROXY))
